  ...
  return (
    <div className="page">
      ...
      <details>
        ...
        <p>
          Because it forces deliberate decisions instead of default ones. The
          wizard walks you through the NAF Framework so you can decide what
          applies to your automation solution — even skipping a block becomes a
          conscious choice, not an oversight, so you end up with a complete
          solution and clear reasoning behind it.
        </p>
      </details>
      ...
      <details>
        ...
        <p>
          A complete, shareable <strong>solution design document</strong> (JSON +
          Markdown + timeline) covering your project context (Problem Statement,
          Use Case, Stakeholders, Dependencies, Timeline) and every NAF component
          (Presentation, Intent, Observability, Orchestration, Collector,
          Executor). Share it with your team, stakeholders, and management to
          align on the design before you build.
        </p>
      </details>
      ...
      <details>
        ...
        <p>
          This wizard is under active development. First up: the ability to
          generate a full <strong>Solution Design Document (SDD)</strong>
          directly from your wizard inputs — a single polished document instead
          of separate JSON, Markdown, and timeline exports.
        </p>
      </details>
